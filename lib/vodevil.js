    ...
    core.prototype = {
        ...
        range: function ( left, right, type ) {
            ...
            */
            ...
            } else if ( typeof left === 'string' && !right || right === 'set' ) {
            ...
            } else if ( typeof left === 'number' && !right || right === 'set' ) {
        ...
        set: function ( target ) {
            ...
            if ( target && self.isArray( target ) ) {
                ...
                var newHash = crypto.createHash('md5');
                    newHash.update( JSON.stringify( target ) );

                output['objectId'] = newHash.digest('base64');
